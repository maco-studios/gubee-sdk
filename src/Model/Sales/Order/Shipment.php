...
/**
 * Model for ShipmentApiDTORes
 * @see https://api.gubee.com.br/api/swagger-ui/#/definitions/ShipmentApiDTORes
 *
...
class Shipment extends AbstractModel implements ShipmentInterface
{
    ...
    public function validate(): bool
    {
        ...
        if (!isset($values['estimatedDeliveryDt'])) {
            $missingFields[] = 'estimatedDeliveryDt';
        }
